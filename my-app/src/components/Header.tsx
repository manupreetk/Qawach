...
export default function Header() {
  ...
  return (
    <header className="bg-warm-brown-15 text-cream-5 shadow-lg ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          <div className="flex items-center space-x-3">
            <Shield className="h-8 w-8 text-sage-green-800" />
            <div>
          ...
          <div className="hidden md:flex space-x-4">
            <button className="px-4 py-2 border border-sage-green-400 text-sage-green-400 rounded-lg hover:bg-sage-green-400 hover:text-green-300 transition-all">
              Join as Artisan
            </button>
            <button className="px-4 py-2 bg- text-sage-green-400 rounded-lg hover:bg-sage-green-400 transition-all">
              Sign In
            </button>
          </div>
          ...
          <div className="md:hidden py-4 border-t border-warm-brown-700">
            <nav className="flex flex-col space-y-4">
              ...
              <div className="flex flex-col space-y-2 pt-4">
                <button className="px-4 py-2 border border-sage-green-400 text-sage-green-400 rounded-lg hover:bg-sage-green-400 hover:text-green-600 transition-all">
                  Join as Artisan
                </button>
